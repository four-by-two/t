...
trait GameKernelTrait
{
    ...
    {
         $decrypt= Crypt::decryptString($input);
         return $decrypt;
    }
    ...
    {
        $kernel = new GameKernel();
        return $kernel->check_freespin_state($internal_token);
    }

    public function freespin_state_completed($internal_token)
    {
        $kernel = new GameKernel();
        return $kernel->freespin_state_completed($internal_token);
    }
