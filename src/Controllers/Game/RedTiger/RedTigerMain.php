...
class RedTigerMain extends GameKernel
{
    ...
    */
    public function game_launch($game_content) {
        return view('wainwright::launcher-content-redtiger')->with('game_content', $game_content);
    }
    ...
    */
    public function modify_game($token_internal, $game_content)
    {
        ...
        $gc = $game_content;
        $new_api_endpoint = config('casino-dog.games.redtiger.new_api_endpoint').$token_internal.'/';  // building up the api endpoint we want to receive game events upon
